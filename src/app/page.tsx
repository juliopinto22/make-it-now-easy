...
export default function App() {
  ...
  const compartilharApp = () => {
    ...
    setStatus('✅ Link copiado! Compartilhe com seus amigos!');
    setTimeout(() => setStatus(''), 4000);
  };
  ...
  const otimizacoesPremium = [
    ...
    { id: 109, nome: '🚀 Vídeo desempenho máximo', cmd: 'powercfg /setacvalueindex scheme_current sub_video 0', perigo: 'alto' },
    { id: 110, nome: '🚀 PCIe desempenho máximo', cmd: 'powercfg /setacvalueindex scheme_current sub_pciexpress 0', perigo: 'alto' },
    ...
    { id: 119, nome: '🚀 Desligar suspensão híbrida', cmd: 'powercfg /setacvalueindex scheme_current sub_sleep 0', perigo: 'alto' },
