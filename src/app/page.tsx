...
// IMAGENS DO KANEKI (pasta /public)
const IMG_HERO_APP = '/kaneki6.webp';
const IMG_FUNDO_ENTRADA = '/KKTG-696x392.webp';
...
export default function LandingPage() {
  const [pcSelecionado, setPcSelecionado] = useState('intermediario');
  ...
  return (
    <div style={{ backgroundColor: CORES.fundo, color: CORES.textoClaro, fontFamily: 'system-ui, sans-serif', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '80px 8%', gap: 40, flexWrap: 'wrap' }}>
        ...
        {/* LADO DIREITO: PREVIEW DO APP / IMAGEM TEMA */}
        <div style={{ flex: '1 1 500px', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '100%', maxWidth: 580, background: CORES.card, border: '1px solid ' + CORES.vermelhoEscuro, borderRadius: 12, padding: 20, boxShadow: '0 0 40px rgba(0,0,0,0.8), 0 0 20px ' + CORES.vermelhoGlow, position: 'relative', overflow: 'hidden' }}>
            ...
            {/* FOTO DO KANEKI EMBUTIDA NO CARD DO APP */}
      ...
      {/* 3. SEÇÃO DE RESULTADOS REAIS (BENCHMARKS NOS JOGOS) */}
