    ...
    >
      <div className="flex max-w-full items-stretch overflow-hidden rounded-full border border-neutral-200 bg-white shadow-sm">
        ...
        >
          ...
          />
          <span className="shrink-0 font-medium text-neutral-900">HappySeeds</span>
        </a>
        <button
          type="button"
          onClick={onClose}
          onPointerDown={(event) => event.stopPropagation()}
          className="flex shrink-0 items-center justify-center px-2.5 text-neutral-400 hover:bg-neutral-50 hover:text-neutral-600"
          aria-label="Close"
        >
